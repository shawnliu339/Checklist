...
<html>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#supplierTable').datagrid({
				...
				idField:'orderId',
				//ajax异步后台请求
				url: 'stockManagement_getBreakStockOutTotalGrid',
				fit: true,
				//自动列间距
				fitColumns: false,
				border: false,
				...
				onClickRow:function(rowIndex,rowData){
			        ...
			        $('#detailGrid').datagrid('options').url = 'stockManagement_getBreakStockOutDetailGrid';
  ...
  <body>
  	<div id="lay" class="easyui-layout" fit=true >
		<div region="north" title="报损出库单据查询" collapsed=false style="height:80px;padding:10px">
		...
		<div region="center" title="报损出库总单">
			<table id="supplierTable"></table>
		</div>
		<div region="south" title="报损出库详单" collapsed=false style="height:40%">
