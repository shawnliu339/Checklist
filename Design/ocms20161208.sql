...
CREATE TABLE IF NOT EXISTS `ocms`.`project` (
  `project_id` INT UNSIGNED NULL AUTO_INCREMENT,
  `prj_id` INT UNSIGNED NULL COMMENT 'プロジェクトID',
...
CREATE TABLE IF NOT EXISTS `ocms`.`checkitem` (
  `checkitem_id` INT UNSIGNED NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ocms`.`checkitem_status` (
  `checkitem_status_id` INT UNSIGNED NULL AUTO_INCREMENT,
  ...
  `checkitem_id` INT UNSIGNED NULL,
